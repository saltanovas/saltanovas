...
SPOTIFY_RECENTLY_PLAYED_URL = "https://api.spotify.com/v1/me/player/recently-played?limit=10"
...
def refreshToken():
    ...
    try:
        ...
        raise Exception("Access token missing. Response: " + str(response))
...
def makeSVG(data, theme):
    if not "is_playing" in data:
        recentPlays = get(SPOTIFY_RECENTLY_PLAYED_URL)
